...
<div class="col-xs-6 col-sm-3 sidebar-offcanvas" role="navigation">
    <ul class="list-group panel">
        <li class="list-group-item"><a href="/video/admin/index"><i class="glyphicon glyphicon-home"></i>首页</a></li>
        <li>
            ...
            <div class="collapse" id="video_set">
                <a href="/video/admin/list" class="list-group-item">所有影片</a>
                <a href="/video/admin/film" class="list-group-item">添加影视</a>
            </div>
        </li>
        <li>
            ...
            <li class="collapse" id="dir_set">
                <a href="/video/admin/editCatalog" class="list-group-item">目录查看</a>
                <a href="/video/admin/catalog" class="list-group-item">目录添加</a>
            </li>
        </li>
        <li>
            ...
            <li class="collapse" id="user_set">
                <a href="/video/admin/userList" class="list-group-item">所有用户</a>
                <a href="/video/admin/vipCode" class="list-group-item">VIP管理</a>
            </li>
        </li>
        <li>
            ...
            <li class="collapse" id="date_set">
                <a href="/video/admin/loadInSolrPage" class="list-group-item">数据导入</a>
            </li>
        </li>
    </ul>
</div>